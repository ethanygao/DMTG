...
class GroupTrevorRepFunction(torch.autograd.Function):
    n=5
    def __init__(self):
        super(GroupTrevorRepFunction, self).__init__()
    ...
    def backward(ctx, grad_output):
        ...
        #print(num_grads)
        grad_input=grad_output.clone()
        mul = 1.0/math.sqrt(GroupTrevorRepFunction.n)
        out = grad_input * mul
        return out

group_trevor_rep_function = GroupTrevorRepFunction.apply


class TaskTrevorRepFunction(GroupTrevorRepFunction):
    n=5
    def __init__(self):
        super(TaskTrevorRepFunction, self).__init__()

task_trevor_rep_function = TaskTrevorRepFunction.apply
